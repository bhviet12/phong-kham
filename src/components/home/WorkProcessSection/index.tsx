          ...
          {steps.map((step, index) => (
            <div key={step.number} className="flex flex-col items-center text-center">
              ...
              <div className="relative w-40 mx-auto mb-4">
                {/* Step image */}
                <div
                  className={`w-40 aspect-square rounded-full overflow-hidden shadow-lg bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center border-2 ${
              ...
              {/* Step content */}
              <h3 className="text-lg lg:text-xl font-bold text-blue-900 mb-2">
                {step.title}
              </h3>
