      ...
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {doctors.map((doctor) => (
            <div
              key={doctor.name}
              className="bg-white rounded-3xl shadow-md hover:shadow-xl transition-shadow duration-300 p-6 lg:p-8 flex flex-col items-center text-center"
            >
              <div className="w-full aspect-[4/5] rounded-3xl overflow-hidden mb-5 bg-gradient-to-br from-teal-100 via-blue-50 to-blue-100 flex items-end justify-center">
