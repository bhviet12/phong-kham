...
const NewsSection = () => {
  ...
  return (
    <section className="py-16 lg:py-24 bg-white relative overflow-hidden">
      ...
      <Container>
        {/* Header */}
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-12 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 relative z-10">
          {newsItems.map((item, index) => (
            ...
            >
              {/* Image */}
              <div className="w-full aspect-[4/3] rounded-t-2xl overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center">
              ...
              <div className="p-6">
                {/* Metadata */}
                <div className="flex items-center gap-3 text-sm text-green-500 mb-4">
                ...
                {/* Title */}
                <h3 className="text-lg lg:text-xl font-bold text-gray-900 mb-4 line-clamp-2">
                  {item.title}
                </h3>
